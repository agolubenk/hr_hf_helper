...
if [ -z "$TELEGRAM_API_ID" ] || [ -z "$TELEGRAM_API_HASH" ]; then
    ...
    echo "python3 manage.py setup_telegram --api-id YOUR_API_ID --api-hash YOUR_API_HASH"
    echo ""
else
    ...
    python3 manage.py setup_telegram --api-id "$TELEGRAM_API_ID" --api-hash "$TELEGRAM_API_HASH"
fi

echo ""
echo "=== Следующие шаги ==="
echo "1. Авторизация в Telegram:"
echo "   python3 manage.py runtelegram --phone +375291234567"
echo ""
echo "2. Синхронизация чатов:"
echo "   python3 manage.py sync_telegram_chats"
echo ""
echo "3. Запуск обработчика событий (в отдельном терминале):"
echo "   python3 manage.py run_telegram_handler"
echo ""
echo "4. Отправка тестового сообщения:"
echo "   python3 manage.py send_telegram_message @username 'Привет!'"
echo ""
