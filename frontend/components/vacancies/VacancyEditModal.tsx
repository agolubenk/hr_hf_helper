...
import { Box, Flex, Text, Button, Dialog, Separator, TextField, TextArea, Card, Table, Select, Checkbox, Switch, DropdownMenu, Badge } from "@radix-ui/themes"
...
export default function VacancyEditModal({ open, onOpenChange, vacancyId, vacancyTitle, vacancy, mode = 'edit', vacancyStatus, onVacancyStatusChange, onSwitchToEdit, onSave }: VacancyEditModalProps) {
  ...
  const getStagesBeforeOffer = () => recruitmentStages.filter(s => {
    const stageIdx = recruitmentStages.findIndex(st => st.id === s.id)
    const offerIdx = recruitmentStages.findIndex(st => st.id === 'offer')
        ...
        <Flex className={styles.body} gap="4">
          ...
          <Box className={styles.content}>
            {selectedSettingTab === 'text' && (
              <Box>
                ...
                <Flex direction="column" gap="4">
                  <Box><Text size="2" weight="medium" mb="2" style={{ display: 'block' }}>Название</Text><TextField.Root value={vacancyTitleS} onChange={(e) => setVacancyTitleS(e.target.value)} placeholder="Введите название вакансии" /></Box>
                  <Box><Text size="2" weight="medium" mb="2" style={{ display: 'block' }}>Отдел</Text><Select.Root value={vacancyDepartment} onValueChange={setVacancyDepartment}><Select.Trigger placeholder="Выберите отдел" /><Select.Content>{getAllDepartmentsFlat(mockDepartments).map(d => <Select.Item key={d.id} value={d.id}>{'  '.repeat(d.level)}{d.name}</Select.Item>)}</Select.Content></Select.Root></Box>
                  <Box><Flex align="center" justify="between" mb="2"><Text size="2" weight="medium">Шапка</Text><Flex align="center" gap="3"><Flex align="center" gap="2"><Text size="1" color="gray">Активность:</Text><Switch checked={fieldSettings.header.active} onCheckedChange={(c) => setFieldSettings(prev => ({ ...prev, header: { ...prev.header, active: !!c } }))} /></Flex><Flex align="center" gap="2"><Text size="1" color="gray">Видимость:</Text><Switch checked={fieldSettings.header.visible} onCheckedChange={(c) => setFieldSettings(prev => ({ ...prev, header: { ...prev.header, visible: !!c } }))} /></Flex></Flex></Flex><TextArea value={vacancyHeader} onChange={(e) => setVacancyHeader(e.target.value)} placeholder="Введите текст шапки" disabled={!fieldSettings.header.active} style={{ minHeight: '100px' }} /></Box>
                  <Box><Flex align="center" justify="between" mb="2"><Text size="2" weight="medium">Обязанности</Text><Flex align="center" gap="3"><Flex align="center" gap="2"><Text size="1" color="gray">Активность:</Text><Switch checked={fieldSettings.responsibilities.active} onCheckedChange={(c) => setFieldSettings(prev => ({ ...prev, responsibilities: { ...prev.responsibilities, active: !!c } }))} /></Flex><Flex align="center" gap="2"><Text size="1" color="gray">Видимость:</Text><Switch checked={fieldSettings.responsibilities.visible} onCheckedChange={(c) => setFieldSettings(prev => ({ ...prev, responsibilities: { ...prev.responsibilities, visible: !!c } }))} /></Flex></Flex></Flex><TextArea value={vacancyResponsibilities} onChange={(e) => setVacancyResponsibilities(e.target.value)} placeholder="Введите обязанности" disabled={!fieldSettings.responsibilities.active} style={{ minHeight: '100px' }} /></Box>
                  <Box><Flex align="center" justify="between" mb="2"><Text size="2" weight="medium">Пожелания</Text><Flex align="center" gap="3"><Flex align="center" gap="2"><Text size="1" color="gray">Активность:</Text><Switch checked={fieldSettings.requirements.active} onCheckedChange={(c) => setFieldSettings(prev => ({ ...prev, requirements: { ...prev.requirements, active: !!c } }))} /></Flex><Flex align="center" gap="2"><Text size="1" color="gray">Видимость:</Text><Switch checked={fieldSettings.requirements.visible} onCheckedChange={(c) => setFieldSettings(prev => ({ ...prev, requirements: { ...prev.requirements, visible: !!c } }))} /></Flex></Flex></Flex><TextArea value={vacancyRequirements} onChange={(e) => setVacancyRequirements(e.target.value)} placeholder="Введите пожелания" disabled={!fieldSettings.requirements.active} style={{ minHeight: '100px' }} /></Box>
                  <Box><Flex align="center" justify="between" mb="2"><Text size="2" weight="medium">Будет плюсом</Text><Flex align="center" gap="3"><Flex align="center" gap="2"><Text size="1" color="gray">Активность:</Text><Switch checked={fieldSettings.niceToHave.active} onCheckedChange={(c) => setFieldSettings(prev => ({ ...prev, niceToHave: { ...prev.niceToHave, active: !!c } }))} /></Flex><Flex align="center" gap="2"><Text size="1" color="gray">Видимость:</Text><Switch checked={fieldSettings.niceToHave.visible} onCheckedChange={(c) => setFieldSettings(prev => ({ ...prev, niceToHave: { ...prev.niceToHave, visible: !!c } }))} /></Flex></Flex></Flex><TextArea value={vacancyNiceToHave} onChange={(e) => setVacancyNiceToHave(e.target.value)} placeholder="Введите что будет плюсом" disabled={!fieldSettings.niceToHave.active} style={{ minHeight: '100px' }} /></Box>
                  <Box><Flex align="center" justify="between" mb="2"><Text size="2" weight="medium">Условия работы</Text><Flex align="center" gap="3"><Flex align="center" gap="2"><Text size="1" color="gray">Активность:</Text><Switch checked={fieldSettings.conditions.active} onCheckedChange={(c) => setFieldSettings(prev => ({ ...prev, conditions: { ...prev.conditions, active: !!c } }))} /></Flex><Flex align="center" gap="2"><Text size="1" color="gray">Видимость:</Text><Switch checked={fieldSettings.conditions.visible} onCheckedChange={(c) => setFieldSettings(prev => ({ ...prev, conditions: { ...prev.conditions, visible: !!c } }))} /></Flex></Flex></Flex><TextArea value={vacancyConditions} onChange={(e) => setVacancyConditions(e.target.value)} placeholder="Введите условия работы" disabled={!fieldSettings.conditions.active} style={{ minHeight: '100px' }} /></Box>
                  <Box><Flex align="center" justify="between" mb="2"><Text size="2" weight="medium">Завершение</Text><Flex align="center" gap="3"><Flex align="center" gap="2"><Text size="1" color="gray">Активность:</Text><Switch checked={fieldSettings.closing.active} onCheckedChange={(c) => setFieldSettings(prev => ({ ...prev, closing: { ...prev.closing, active: !!c } }))} /></Flex><Flex align="center" gap="2"><Text size="1" color="gray">Видимость:</Text><Switch checked={fieldSettings.closing.visible} onCheckedChange={(c) => setFieldSettings(prev => ({ ...prev, closing: { ...prev.closing, visible: !!c } }))} /></Flex></Flex></Flex><TextArea value={vacancyClosing} onChange={(e) => setVacancyClosing(e.target.value)} placeholder="Введите завершающий текст" disabled={!fieldSettings.closing.active} style={{ minHeight: '100px' }} /></Box>
                  <Box><Flex align="center" justify="between" mb="2"><Text size="2" weight="medium">Дополнительная ссылка</Text><Flex align="center" gap="3"><Flex align="center" gap="2"><Text size="1" color="gray">Активность:</Text><Switch checked={fieldSettings.link.active} onCheckedChange={(c) => setFieldSettings(prev => ({ ...prev, link: { ...prev.link, active: !!c } }))} /></Flex><Flex align="center" gap="2"><Text size="1" color="gray">Видимость:</Text><Switch checked={fieldSettings.link.visible} onCheckedChange={(c) => setFieldSettings(prev => ({ ...prev, link: { ...prev.link, visible: !!c } }))} /></Flex></Flex></Flex><TextField.Root value={vacancyLink} onChange={(e) => setVacancyLink(e.target.value)} placeholder="https://example.com/vacancy" disabled={!fieldSettings.link.active} /></Box>
                  <Box><Flex align="center" justify="between" mb="2"><Text size="2" weight="medium">Вложения</Text><Flex align="center" gap="3"><Flex align="center" gap="2"><Text size="1" color="gray">Активность:</Text><Switch checked={fieldSettings.attachment.active} onCheckedChange={(c) => setFieldSettings(prev => ({ ...prev, attachment: { ...prev.attachment, active: !!c } }))} /></Flex><Flex align="center" gap="2"><Text size="1" color="gray">Видимость:</Text><Switch checked={fieldSettings.attachment.visible} onCheckedChange={(c) => setFieldSettings(prev => ({ ...prev, attachment: { ...prev.attachment, visible: !!c } }))} /></Flex></Flex></Flex>
                    <Flex direction="column" gap="2"><input type="file" accept=".docx,.pptx,.figma" onChange={(e) => setVacancyAttachment(e.target.files?.[0] || null)} disabled={!fieldSettings.attachment.active} id="vacancy-edit-modal-attachment" style={{ position: 'absolute', opacity: 0, width: 0, height: 0 }} /><Button asChild variant="soft" disabled={!fieldSettings.attachment.active} style={{ width: '100%', justifyContent: 'flex-start' }}><label htmlFor="vacancy-edit-modal-attachment" style={{ cursor: fieldSettings.attachment.active ? 'pointer' : 'not-allowed', display: 'flex', alignItems: 'center', gap: 8 }}><UploadIcon width={16} height={16} /><Text size="2">{vacancyAttachment ? vacancyAttachment.name : 'Выберите файл (docx, pptx, figma)'}</Text></label></Button>{vacancyAttachment && <Flex align="center" gap="2" style={{ padding: '8px 12px', backgroundColor: 'var(--gray-2)', borderRadius: 6 }}><FileTextIcon width={16} height={16} /><Text size="2" style={{ flex: 1 }}>{vacancyAttachment.name}</Text><Text size="1" color="gray">{(vacancyAttachment.size / 1024).toFixed(2)} KB</Text><Button size="1" variant="ghost" color="red" onClick={() => setVacancyAttachment(null)}><Cross2Icon width={14} height={14} /></Button></Flex>}</Flex>
                  </Box>
                </Flex>
              </Box>
            )}
            ...
            {selectedSettingTab === 'questions' && (
              <Box><Text size="3" weight="bold" mb="3" style={{ display: 'block' }}>Вопросы и ссылки</Text><Text size="2" color="gray" mb="4" style={{ display: 'block' }}>Ссылка на вакансию, тогглер использования на сайте и один вопрос по вакансии на офис. Настройки задаются отдельно для каждого офиса. У ссылки и вопроса можно выбрать цвет.</Text>
                <Flex direction="column" gap="4">{questionLinkOffices.map((office) => {
                  ...
                  return <Card key={office.id} style={{ padding: 16 }}><Flex direction="column" gap="4"><Text size="4" weight="bold">{office.name}</Text>
                    <Box><Text size="3" weight="medium" mb="2" style={{ display: 'block' }}>Ссылка на вакансию</Text><Flex direction="column" gap="3"><Flex align="center" gap="3" wrap="wrap"><TextField.Root value={link.url} onChange={(e) => updateOfficeLink(office.id, { url: e.target.value })} placeholder="https://example.com/vacancy" style={{ flex: 1, minWidth: 200 }} /><Flex align="center" gap="2"><Text size="2" color="gray">Использовать с сайта:</Text><Switch checked={link.useOnSite} onCheckedChange={(c) => updateOfficeLink(office.id, { useOnSite: !!c })} /></Flex></Flex><Flex align="center" gap="2"><Text size="2" weight="medium">Цвет ссылки:</Text>{questionLinkColors.map((c) => <button key={c.id} type="button" onClick={() => updateOfficeLink(office.id, { color: c.hex })} title={c.label} style={{ width: 28, height: 28, borderRadius: 6, backgroundColor: c.hex, border: link.color === c.hex ? '2px solid var(--gray-12)' : '2px solid transparent', cursor: 'pointer', padding: 0 }} aria-pressed={link.color === c.hex} />)}</Flex></Flex></Box>
                    <Separator size="4" /><Box><Text size="3" weight="medium" mb="2" style={{ display: 'block' }}>Вопрос по вакансии</Text><Flex direction="column" gap="2"><TextArea value={q.text} onChange={(e) => updateOfficeQuestion(office.id, { text: e.target.value })} placeholder="Текст вопроса..." style={{ minWidth: '100%', minHeight: 60 }} /><Flex gap="2" align="center"><Text size="2" color="gray">Цвет:</Text>{questionLinkColors.map((c) => <button key={c.id} type="button" onClick={() => updateOfficeQuestion(office.id, { color: c.hex })} title={c.label} style={{ width: 22, height: 22, borderRadius: 4, backgroundColor: c.hex, border: q.color === c.hex ? '2px solid var(--gray-12)' : '2px solid transparent', cursor: 'pointer', padding: 0 }} />)}</Flex></Flex></Box></Flex></Card>
                })}</Flex>
              </Box>
            )}
