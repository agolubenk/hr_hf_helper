...
Эта директория содержит детальные спецификации для различных аспектов API HR Helper. Документы связаны перекрёстными ссылками. Сводка по всем спецификациям: **[SUMMARY.md](./SUMMARY.md)**.
