 ...
 * 
 * Назначение:
 * - Отображение списка чатов интеграции Telegram с HR Helper
 * - Поиск чатов по названию
 * - Просмотр информации о чатах (название, превью последнего сообщения, дата)
 * 
 * Функциональность:
 * - Список чатов с аватарами, названиями и превью сообщений
 * - Поиск по чатам (в разработке)
 ...
 * 
 * Поведение:
 * - При загрузке отображает список всех чатов интеграции
 * - При вводе в поле поиска должен фильтровать чаты (в разработке)
 * - При клике на чат должен открываться детальный просмотр (в разработке)
 * 
 * TODO: Реализовать реальный поиск и фильтрацию чатов
 * TODO: Реализовать переход к детальному просмотру чата
 */
...
export default function TelegramChatsPage() {
  ...
  /**
   * handleSaveInlineField - обработчик сохранения поля при редактировании инлайн
   */
  ...
  /**
   * handleCreateFolder - обработчик создания новой папки
   */
  ...
  /**
   * handleDragEnd - обработчик окончания перетаскивания папки
   */
  ...
  /**
   * handleAccountImageUpload - обработчик загрузки изображения профиля
   */
  ...
  /**
   * handleAccountImageChange - обработчик выбора изображения профиля
   */
  ...
  /**
   * handleChatImageUpload - обработчик загрузки изображения чата
   */
  ...
  /**
   * handleChatImageChange - обработчик выбора изображения чата
   */
  ...
  /**
   * handleSaveAccountField - обработчик сохранения поля аккаунта при редактировании инлайн
   */
  ...
  /**
   * handleAddException - обработчик добавления чата в исключения
   */
  ...
  /**
   * handleRemoveException - обработчик удаления чата из исключений
   */
